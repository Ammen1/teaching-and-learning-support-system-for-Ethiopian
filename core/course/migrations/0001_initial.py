    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(blank=True, choices=[(1, '1'), (2, '2'), (3, '3'), (4, '4'), (4, '5'), (4, '6')], default=0, null=True)),
                ...
                ('lecturer', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='courses_taught', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Program',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dep_head', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account.departmenthead')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cores.session')),
            ],
        ),
        migrations.AddField(
            model_name='course',
